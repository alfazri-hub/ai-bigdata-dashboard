...
const teamMembers = [
  { name: "Reski Faras Adiefa", photo: "/images/reski.png", instagram: "https://www.instagram.com/reskiif/" },
  { name: "Muhammad Al Fazri", photo: "/images/fazri.png", instagram: "https://www.instagram.com/muhammad.alfazri/" },
  { name: "Rolas Dwi Putra Sijabat", photo: "/images/rolas.png", instagram: "https://www.instagram.com/ssepuluhh/" },
  { name: "Auranisa Amalia", photo: "/images/auranisa.png", instagram: "https://www.instagram.com/auranisamlia/" }
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-[850px] mx-auto">
        ...
        <div className="flex flex-col gap-8 animate-slide-in-left">
          {teamMembers.slice(0, 2).map((member, idx) => (
            ...
            >
              <Card variant="default" className="p-8 text-center flex flex-col items-center justify-center min-h-[260px] bg-[#121226]/80 border border-white/5 backdrop-blur-sm rounded-[28px] relative overflow-hidden group-hover:border-blue-500/30 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] transition-all duration-300">
                <div className="absolute top-0 right-0 w-24 h-24 bg-blue-500/5 rounded-full blur-3xl group-hover:bg-blue-500/15 transition-all pointer-events-none"></div>
        ...
        <div className="flex flex-col gap-8 animate-slide-in-right">
          {teamMembers.slice(2, 4).map((member, idx) => (
            <a
              ...
              className="block group focus:outline-none cursor-pointer"
            >
              <Card variant="default" className="p-8 text-center flex flex-col items-center justify-center min-h-[260px] bg-[#121226]/80 border border-white/5 backdrop-blur-sm rounded-[28px] relative overflow-hidden group-hover:border-purple-500/30 group-hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all duration-300">
                <div className="absolute top-0 right-0 w-24 h-24 bg-purple-500/5 rounded-full blur-3xl group-hover:bg-purple-500/15 transition-all pointer-events-none"></div>
